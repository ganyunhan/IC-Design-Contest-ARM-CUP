...
#ifndef __voicerec_fcmp_32njbC__HH__
#define __voicerec_fcmp_32njbC__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(voicerec_fcmp_32njbC) {
    ...
    SC_CTOR(voicerec_fcmp_32njbC):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);

...
#ifndef __voicerec_fpext_32ibs__HH__
#define __voicerec_fpext_32ibs__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(voicerec_fpext_32ibs) {
    ...
    SC_CTOR(voicerec_fpext_32ibs):  ACMP_fpext_U ("ACMP_fpext_U") {

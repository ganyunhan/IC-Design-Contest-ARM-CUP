...
#ifndef __voicerec_sdiv_11ndEe__HH__
#define __voicerec_sdiv_11ndEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(voicerec_sdiv_11ndEe) {
    ...
    SC_CTOR(voicerec_sdiv_11ndEe):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {

...
set Interfaces {
    s_axi_voice_rec {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_voice_rec"
        param_prefix "C_S_AXI_VOICE_REC"
        addr_bits "5"
    ...
    ap_clk {
        ...
        buses "s_axi_voice_rec m_axi_voice_rec"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_voice_rec {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_voice_rec"
        data_width "32"
        param_prefix "C_M_AXI_VOICE_REC"
        ...
        has_dependant_on "1"
        offset_slave_name "s_axi_voice_rec"
...
## System Info
set user_parameters_list {clk_period 5 machine 64 combinational 0 latency 600025 II x}
